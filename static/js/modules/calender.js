...
mvAry[mvAry.length] = '        <th align="center" width="98%" nowrap="nowrap"><select name="calendarYear" id="calendarYear" style="font-size:12px;width:75px;line-height:26px;height:26px;margin:0px"></select><select name="calendarMonth" id="calendarMonth" style="font-size:12px;width:65px;line-height:26px;height:26px;margin:0px"></select></th>';
...
//显示日历
Calendar.prototype.show = function (dateControl, popControl,istop) {
if (dateControl == null){
...
if(istop==undefined){
    ...
    if(BW.isFirefox){
    this.panel.style.top = (xy.y-dateControl.offsetHeight-190) + "px";
    }else{
     this.panel.style.top = (xy.y-200) + "px";
    }
...
$(calendar.dateControl).trigger('change');
}
